...
namespace TSUtils.Sounds
{
    public class SoundManager : MonoBehaviour
    {
        ...
        public SoundHandler Play(ISound sound, float additionalDelay = 0, float additionalPitch = 0)
        {
            if (sound == null)
                return null;
            ...
            var pitch = sound.GetPitch() + additionalPitch;
            var delay = sound.GetDelay() + additionalDelay;
